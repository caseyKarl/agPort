...
let DemoComponent = class DemoComponent {
    ...
    openShootSheet() {
        const url = 'https://cpkrigging.com/shotSheet.html';
        window.open(url);
    }
    openFlatBook() {
        const url = 'https://cpkrigging.com/Flatbook2_pass1.pdf';
        window.open(url);
    }
};
...
let ResumePageComponent = class ResumePageComponent {
    constructor(envSettings) {
        this.envSettings = envSettings;
        this.imgPath = '';
        this.pdfSrc = '';
...
ResumePageComponent.ctorParameters = () => [
    { type: _service_enviroment_settings_service__WEBPACK_IMPORTED_MODULE_2__["EnvironmentSettingsService"] }
];
